...
function EventList() {
  ...
  return (
    <div className="container py-5">
      ...
      {/* Complaint box — organizers can raise complaints to admin, and see
          complaints users have raised about their own events. Not shown to
          admins, who get a dedicated Complaints panel instead. */}
